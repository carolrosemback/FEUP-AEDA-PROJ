...
void Menu::save()
{
    ...
    for(Aeroporto* aeroporto: aeroportos)
    {
       ...
       for(Aviao* aviao: aeroporto->getAvioes())
       {
           ...
           file << aviao->getTempoMedio() <<endl;
           file << aviao->getTempoTotal() << endl;
...
void Menu::load()
{
    ...
    while (!file.eof())
    {
        ...
        while (1)
        {
            ...
            Aviao* aviao = new Aviao(tipo,capacidade,voos_aviao,{},custo_de_operacao, tempMedio, tempTotal);
        ...
        Aeroporto* a = new Aeroporto(nullptr, localizacao, funcionarios, avioes, pilotos, membros_tripulacao,
